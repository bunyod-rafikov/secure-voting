...
class ResponseAPDU(apdu: ByteArray) : Serializable {
     ...
     *
     * @param other the object to be compared for equality with this response APDU
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is ResponseAPDU) {
            return false
        }
        return Arrays.equals(apdu, other.apdu)
    }
